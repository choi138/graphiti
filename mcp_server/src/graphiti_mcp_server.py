    ...
    try:
        ...
        if config.graphiti.search_mode == 'bm25':
            ...
            if center_node_uuid:
                ...
                rank_scores = list(results.edge_reranker_scores or [])[:max_facts]
        else:
            ...
            # client.search returns plain edges without reranker scores.
            rank_scores = []
            ...
            try:
                ...
                for edge in relevant_edges:
                    ...
                    dot_product = sum(
                        ...
                        for query_value, embedding_value in zip(query_vec, embedding, strict=True)
                    )
